class LocaleHelper {
    static EN = {
        title: "About — UTF-8 Art Editor",
        headerTitle: "UTF-8 Art Editor",
        navEditor: "Editor",
        navAbout: "About",
        aboutHeading: "About",
        aboutPara1: "<strong>UTF-8 Art Editor</strong> is a minimal, standalone web app for crafting blocky or UTF‑8 art in your browser. No installation, no backend, no build tools—just open <code>index.html</code> and start creating.",
    ...
    static ES = {
        title: "Acerca de — UTF-8 Art Editor",
        headerTitle: "UTF-8 Art Editor",
        navEditor: "Editor",
        navAbout: "Acerca de",
        aboutHeading: "Acerca de",
        aboutPara1: "<strong>UTF-8 Art Editor</strong> es una aplicación web minimalista e independiente para crear arte de bloques o UTF‑8 en tu navegador. Sin instalación, sin backend, sin herramientas de construcción: solo abre <code>index.html</code> y comienza a crear.",
